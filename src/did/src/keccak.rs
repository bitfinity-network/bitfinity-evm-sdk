...
pub const KECCAK_NULL_RLP: H256 = Hash::<alloy_primitives::B256>(alloy_primitives::B256::new([
    0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6, 0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e,
    0x5b, 0x48, 0xe0, 0x1b, 0x99, 0x6c, 0xad, 0xc0, 0x01, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21,
]));

/// The KECCAK of the empty byte slice
pub const KECCAK_EMPTY: H256 = Hash::<alloy_primitives::B256>(alloy_primitives::B256::new([
...
pub const KECCAK_EMPTY_LIST_RLP: H256 = Hash::<alloy_primitives::B256>(alloy_primitives::B256::new([
