...
impl From<Bytes> for alloy_primitives_08::Bytes {
    fn from(value: Bytes) -> Self {
        alloy_primitives_08::Bytes(value.0)
    }
}

impl From<alloy_primitives_08::Address> for H160 {
    fn from(value: alloy_primitives_08::Address) -> Self {
        H160::from_slice(value.as_slice())
    }
}

impl From<H160> for alloy_primitives_08::Address {
    fn from(value: H160) -> Self {
        alloy_primitives_08::Address::from_slice(value.0.as_bytes())
    }
}

impl From<alloy_primitives_08::B64> for H64 {
    fn from(value: alloy_primitives_08::B64) -> Self {
        H64::from_slice(value.as_slice())
    }
}

impl From<H64> for alloy_primitives_08::B64 {
    fn from(value: H64) -> Self {
        alloy_primitives_08::B64::from_slice(value.0.as_bytes())
    }
}

impl From<alloy_primitives_08::B256> for H256 {
    fn from(value: alloy_primitives_08::B256) -> Self {
        H256::from_slice(value.as_slice())
    }
}

impl From<H256> for alloy_primitives_08::B256 {
    fn from(value: H256) -> Self {
        alloy_primitives_08::B256::from_slice(value.0.as_bytes())
    }
}
...
mod utypes_conversion {
    ...
    impl From<U64> for alloy_primitives_08::U64 {
        fn from(value: U64) -> Self {
            ...
            value.0.to_little_endian(&mut bytes);
            alloy_primitives_08::U64::from_le_bytes(bytes)
        }
    }
}
...
mod test {
    ...
    fn test_alloy_bytes_roundtrip() {
        ...
        let alloy_bytes = alloy_primitives_08::Bytes::from(value.clone());
    ...
    fn test_alloy_address_roundtrip() {
        ...
        let alloy_address = alloy_primitives_08::Address::from(value.clone());
    ...
    fn test_alloy_h256_roundtrip() {
        ...
        let alloy_h256 = alloy_primitives_08::B256::from(value.clone());
    ...
    fn test_alloy_h64_roundtrip() {
        ...
        let alloy_h64 = alloy_primitives_08::B64::from(value.clone());
    ...
    fn test_alloy_u256_roundtrip() {
        ...
        let alloy_u256: alloy_primitives_08::U256 = value.clone().into();
    ...
    fn test_alloy_u64_roundtrip() {
        ...
        let alloy_u64: alloy_primitives_08::U64 = value.into();
